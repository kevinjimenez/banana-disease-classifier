...
python3 scripts/auto_config.py \
    ...
    --no_wandb \
    --output cnn/train_cnn_config.sh
...
cp cnn/train_cnn_config.sh "$EXPERIMENT_DIR/train_cnn_config.sh"

echo ""
echo "📋 Configuración de entrenamiento:"
echo ""
cat cnn/train_cnn_config.sh
echo ""
...
echo "  ⚙️  Configuración:             $EXPERIMENT_DIR/train_cnn_config.sh"
