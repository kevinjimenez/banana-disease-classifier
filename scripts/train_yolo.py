...
Uso:
    python scripts/train_yolo.py --data_dir ./data --model_size s --epochs 100
...
try:
    ...
    from yolo.yolo_utils import validate_yolo_dataset, print_dataset_summary
...
Ejemplos:
  ...
  python scripts/train_yolo.py --data_dir ./data --model_size s --epochs 50
  
  # Entrenamiento con configuración avanzada
  python scripts/train_yolo.py --data_dir ./data --model_size m --epochs 100 \\
      --batch_size 64 --lr 0.001 --image_size 224
  
  # Prueba rápida
  python scripts/train_yolo.py --data_dir ./data --model_size n --epochs 5 --quick_test
        """,
    )
