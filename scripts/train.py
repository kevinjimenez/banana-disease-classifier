...
Ejemplo de uso:
    python scripts/train.py --data_dir ./data/train --model convnext_base --epochs 50
"""
...
from deep.config.config import Config, get_quick_test_config, get_production_config
from deep.core.dataset import BananaDiseaseDataset, create_dataloaders
from deep.core.transforms import get_transforms
from deep.core.inference import BananaClassifier, ModelRegistry
