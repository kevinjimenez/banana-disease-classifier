...
Ejemplo de uso:
    python cnn/evaluate.py --checkpoint checkpoints/best_model.pth --data_dir ./data/test
"""
...
from cnn.core.dataset import BananaDiseaseDataset
from cnn.core.transforms import get_transforms, AugmentationPolicy
